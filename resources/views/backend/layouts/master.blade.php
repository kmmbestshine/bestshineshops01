        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{route('user.dashboard')}}" class="site_title"><i class="fa fa-user"></i> <span> Aquatech RO System</span></a>
                </div>
       ...
       @yield('content')
        ...
        <footer>
            <div class="pull-right">
                Copy Right All Reserve <a href="">Bestshine Software Solutions</a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
