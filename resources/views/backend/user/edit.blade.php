                        ...
                        <div class="x_content">
                            <form action="{{route('user.update',$users->id)}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" placeholder="Username" class="form-control" value="{{$users->username}}"/>
                                    <span class="error">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" placeholder="Password" class="form-control" value="{{$users->remember_token}}"/>
                                    <span class="error">
